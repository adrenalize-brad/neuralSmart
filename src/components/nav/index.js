    ...
    return(
        ...
        <div id="navbar" className={`glass flex absolute z-20 ${navClass} ${navTransition}`} style={{height: navbarHeight, top: navbarTop}}>
            ...
            { display === 'mobile' ?
                ...
                >
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 h-1 rounded-lg shadow-md transform transition duration-300 ease-in-out ${menuLinksOpen === true ? '-translate-y-1/2 rotate-45 bg-blue-600 w-8' : '-translate-y-3 bg-gray-100 bg-opacity-75 w-12' }` } />
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1 rounded-lg shadow-md transform transition duration-200 ease-in-out ${menuLinksOpen === true ? 'scale-0' : 'bg-gray-100 bg-opacity-75 w-12' }` } />
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 h-1 rounded-lg shadow-md transform transition duration-300 ease-in-out ${menuLinksOpen === true ? '-translate-y-1/2 -rotate-45 bg-blue-600 w-8' : 'translate-y-2 bg-gray-100 bg-opacity-75 w-12' }` } />
                </div>
            : 
                null 
            } 
